...
const ProtectedLayout = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-tr from-slate-50 via-unwind-bg to-unwind-lavender-light/20">
      <Navbar />
      <main className="flex-grow max-w-7xl w-full mx-auto px-6 py-8 flex flex-col">
        <div className="bg-white/40 border border-white/20 p-2 rounded-xl mb-6 text-xs text-unwind-blue-dark flex items-center gap-2">
          <span>🔒</span>
