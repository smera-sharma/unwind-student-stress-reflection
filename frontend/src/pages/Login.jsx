...
const Login = () => {
  ...
  return (
    <div className="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative">
      {/* Lavender blur backdrop */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-gradient-to-tr from-unwind-lavender-light to-unwind-blue-light rounded-full blur-[80px] opacity-30 pointer-events-none -z-10" />
      ...
      <div className="max-w-md w-full space-y-8 glass-panel p-8 rounded-3xl border border-white/50 shadow-glass">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-slate-500">
            Or{' '}
            <Link to="/register" className="font-semibold text-unwind-blue-dark hover:underline">
